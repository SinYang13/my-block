  ...
  methods: {
    ...
    submitLoan() {
      ...
      if (inputDate >= currentDate) {
        ...
        const loanRef = collection(
          db,
          "loans/" + this.currItemName + "/rental"
        );
        addDoc(loanRef, {
    ...
    scheduleEvent() {
      ...
      const event = {
        ...
        location:
          "4B Boon Tiong Rd, #01-35 Boon Tiong Arcadia, Singapore 165004",
        description:
          "Your deadline is on friday regardless of when u collect it:)",
        start: {
          dateTime: start,
